      ...
      <div class="main-panel">
                  ...
                  <tbody>
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<td>" . $row["utr"] . "</td>";
                            echo "<td><a href='https://bhaaratclubs.netlify.app/uploads/" . $row["file_upload"] . "'>" . $row["file_upload"] . "</a></td>";
                            echo "<td><a href='https://bhaaratclubs.netlify.app/uploads/" . $row["image_upload"] . "'>" . $row["image_upload"] . "</a></td>";
        ...
        <footer class="footer">
          <div class="d-sm-flex justify-content-center justify-content-sm-between">
            <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © Selim XPro 2025</span>
          </div>
        </footer>
      </div>
    </div>
