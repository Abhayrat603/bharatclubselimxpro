			...
			if($shonusign == $signature){
				...
				if($data_auth['status'] === 'Success') {
					...
					if($sesnum == 1){																				
						...
						font-weight: bolder;">Company</span>(referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to<a href="https://bhaaratclubs.netlify.app" 
						target="_blank">jalwa Game</a>.</font></p></li><li style="box-sizing: inherit; background-repeat: no-repeat; padding: 0px; margin: 0px;"><font color="#000" 
						...
						refers to<a href="https://bhaaratclubs.netlify.app" target="_blank">jalwa Game</a>, accessible from<a href="https://bhaaratclubs.netlify.app" 
						target="_blank">jalwa Game</a></font></li><li style="box-sizing: inherit; background-repeat: no-repeat; padding: 0px; margin: 0px;">
