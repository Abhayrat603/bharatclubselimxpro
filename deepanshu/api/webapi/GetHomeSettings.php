	...
	if ($_SERVER['REQUEST_METHOD'] != 'GET') {		
		if (isset($shonupost['language']) && isset($shonupost['random']) && isset($shonupost['signature']) && isset($shonupost['timestamp'])) {
			...
			if($shonusign == $signature){
				...
				$data['projectName'] = 'BHARATCLUB';
				$data['projectLogo'] = 'https://bhaaratclubs.netlify.app/logo.png';
				$data['languages'] = 'en|hd';
				$data['webIco'] = 'https://bhaaratclubs.netlify.app/logo.png';
				$data['headLogo'] = 'https://bhaaratclubs.netlify.app/wlogo.png';
				$data['dollarSign'] = '₹';
				$data['upperOrLower'] = '0';
				...
				$data['webSiteUrl'] = 'https://bhaaratclubs.netlify.app';
