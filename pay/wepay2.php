...
if ($demoResult->num_rows > 0) {
    ...
    header('Location: https://bhaaratclubs.netlify.app/#/main');
    exit;
}
...
if (isset($_GET['tyid']) && isset($_GET['amount']) && isset($_GET['uid']) && isset($_GET['sign']) && isset($_GET['urlInfo'])) {
    ...
    $theirurl = $urlarr[0];
    $myurl = 'https://bhaaratclubs.netlify.app';
    ...
    if($myurl){
        ...
        // Set up parameters
        $notify_url = "https://bhaaratclubs.netlify.app/pay/lgwebhook.php";
...
if ($apiData) {
    ...
    $app_id = $config['app_id'];
        ...
        $params = [
            ...
            'trade_type' => 'INRUPI',
            'order_sn' => $serial,
            'return_url' => 'https://bhaaratclubs.netlify.app',
        ];
